...
df = df.dropna(subset=['Dia', 'Temperatura'])
...
# Supondo que o arquivo tem colunas 'Dia' e 'Temperatura'
X = df[['Dia']]  # Usar apenas a coluna 'Dia' como entrada
y = df['Temperatura']
...
# Criar um DataFrame para armazenar os dias do ano de 2025
novos_dados = pd.DataFrame({
    'Dia': datas_2025.day  # Extrair o dia do mês
})

# Fazer previsões para o ano de 2025
previsoes_2025 = model.predict(novos_dados[['Dia']])  # Usar apenas a coluna 'Dia'
...
# Exibir as previsões
print(novos_dados[['Data', 'Temperatura Prevista']])
