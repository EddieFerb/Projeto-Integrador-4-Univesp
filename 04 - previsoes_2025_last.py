...
X = df[['Dia', 'Umidade', 'Velocidade do Vento']]  # Usar 'Dia', 'Umidade', 'Velocidade do Vento' como entradas
y = df['Temperatura']
...
previsoes_2025 = model.predict(novos_dados[['Dia', 'Umidade', 'Velocidade do Vento']])  # Usar todas as colunas
